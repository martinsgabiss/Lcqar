...
import datetime
from netCDFcreator import createNETCDFtemporalAndLayered, createNETCDFtemporalAndLayered_netcdf3
...
if __name__ == '__main__':
    ...
    for d in range(26,29):
        print(d)
        YYYYMMDD = '2022-12-'+str(d).zfill(2)
        date = YYYYMMDD
        ...
        mcipGRIDDOT2DPath = mcipPath+'/GRIDDOT2D_'+gridName+'_'+date+'.nc'
        mcipGRIDCRO2DPath = mcipPath+'/GRIDCRO2D_'+gridName+'_'+date+'.nc'
        mcipMETCRO3Dpath = mcipPath+'/METCRO3D_'+gridName+'_'+date+'.nc'
        mcipMETCRO2Dpath = mcipPath+'/METCRO2D_'+gridName+'_'+date+'.nc' 
        gridId = gridName+'_'+'MCIPgrid' # grid definition identification
        dataTempo=None
        dataTempo,colunasX = gridSpecMCIP (rootPath,outPath,date,
        ...
        createNETCDFtemporalAndLayered(rootPath,outPath,name,dataTempo,mcipMETCRO3Dpath,colunasX)
        
        createNETCDFtemporalAndLayered_netcdf3(rootPath,outPath,name+'_netcdf3',dataTempo,mcipMETCRO3Dpath,colunasX)
